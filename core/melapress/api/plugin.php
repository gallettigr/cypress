<?php
/**
 * Plugin Name: MelaPress API
 * Description: JSON-based REST API for MelaPress, based on WP-API.org
 * Author: gallettigr
 * Author URI: http://www.twitter.com/gallettigr
 * Version: 1.0
 * Plugin URI: https://www.melacommunication.com
 */
...
function json_api_default_filters( $server ) {
	global $wp_json_posts, $wp_json_pages, $wp_json_media, $wp_json_taxonomies, $bbp_json_forums, $bbp_json_topics, $bbp_json_replies;
