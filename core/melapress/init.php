 ...
 */
/*
Plugin Name: MelaPress First Run
Contributors: @gallettigr
Plugin URI: http://dotsqr.co
Description: Initial WordPress config by MelaPress.
Author: @gallettigr
Version: 1.0
...
if ( dotsqrpress_option_check('dotsqrpress','init_flag') === 0 ) {
	...
	function dotsqrpress_first_run() {
	  ...
	  update_option('blogdescription', get_bloginfo('name') . ' powered by MelaPress');
	  update_option('uploads_use_yearmonth_folders', 0);
	  update_option('default_comment_status', 'closed');
	  update_option('admin_email', 'gallettigr@melacommunication.com');
