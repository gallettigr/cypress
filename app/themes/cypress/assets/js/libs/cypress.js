...
jQuery.fn.extend({
  cyslider: function(options) {
    var slideheight = $('ul li', this).outerHeight(),
        defaults = { speed: 5000, easing: 'easeOutBack' },
        slide = $('ul li', this),
        slider = $('ul', this);
  ...
  cyrousel: function(options) {
    var defaults = { speed: 700, easing: 'swing', interval: 10000 },
        slides = $('.item', this),
        count = slides.length,
    ...
    setTimeout(function(){
      slides.css({transition: 'opacity ' + settings.speed + 'ms linear' });
    }, 25);
